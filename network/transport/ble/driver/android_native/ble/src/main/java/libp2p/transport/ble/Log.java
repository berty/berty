...
final class Log {
    ...
    static void v(final String tag, final String log) {
        if (goLoggerEnabled) {
    ...
    static void d(final String tag, final String log) {
        if (goLoggerEnabled) {
    ...
    static void i(final String tag, final String log) {
        if (goLoggerEnabled) {
    ...
    static void w(final String tag, final String log) {
        if (goLoggerEnabled) {
    ...
    static void e(final String tag, final String log) {
        if (goLoggerEnabled) {
    ...
    static String connectionStateToString(final int state) {
        switch (state) {
    ...
    static String bluetoothAdapterStateToString(final int state) {
        switch (state) {
            case STATE_OFF:
                return "off";
    ...
    static String gattStatusToString(final int status) {
