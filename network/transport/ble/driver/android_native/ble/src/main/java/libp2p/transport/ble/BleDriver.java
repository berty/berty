...
final class BleDriver {
    ...
    static void setLocalPeerID(final String localPeerID) { peerIDCharacteristic.setValue(localPeerID); }
    static String getLocalPeerID() { return peerIDCharacteristic.getStringValue(0); }

    static void setContext(final Context context) { appContext = context; }
    static Context getContext() { return appContext; }
    ...
    private static boolean setupService() {
        ...
        BluetoothManager bluetoothManager = (BluetoothManager)appContext.getSystemService(BLUETOOTH_SERVICE);
    ...
    static void setAdvertisingState(final boolean state) {
        Log.d(TAG, "setAdvertisingState() called with state: " + state);

        advertising = state;
    }

    static void setScanningState(final boolean state) {
