...
var _ dht.Routing = (*BertyRouting)(nil)
...
func NewBertyRouting(ctx context.Context, h host.Host, r dht.Routing) (*BertyRouting, error) {
	br := &BertyRouting{
		routing: r,
...
func (br *BertyRouting) Close() error {
	return br.routing.Close()
}
