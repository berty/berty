...
func (EventExtensionVersions) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_sigchain_4bb2151cf03b1b5e, []int{0}
}
...
func (SigEvent_SigEventType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_sigchain_4bb2151cf03b1b5e, []int{0, 0}
}
...
func (*SigChain) Descriptor() ([]byte, []int) {
	return fileDescriptor_sigchain_4bb2151cf03b1b5e, []int{1}
}
...
func (*EventExtension) Descriptor() ([]byte, []int) {
	return fileDescriptor_sigchain_4bb2151cf03b1b5e, []int{2}
}
...
func init() {
	proto.RegisterFile("crypto/sigchain/sigchain.proto", fileDescriptor_sigchain_4bb2151cf03b1b5e)
}

var fileDescriptor_sigchain_4bb2151cf03b1b5e = []byte{
