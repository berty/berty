...
const (
	SigEvent_InitChain    SigEvent_SigEventType = 0
	SigEvent_AddDevice    SigEvent_SigEventType = 1
	SigEvent_RemoveDevice SigEvent_SigEventType = 2
)
...
func (SigEvent_SigEventType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_sigchain_c82f7aa4d38351d1, []int{0, 0}
}
...
func (*SigEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_sigchain_c82f7aa4d38351d1, []int{0}
}
...
func (*SigChain) Descriptor() ([]byte, []int) {
	return fileDescriptor_sigchain_c82f7aa4d38351d1, []int{1}
}
...
func (m *SigChain) GetPeerId() string {
	if m != nil {
		return m.PeerId
	}
	return ""
...
func (*EventExtension) Descriptor() ([]byte, []int) {
	return fileDescriptor_sigchain_c82f7aa4d38351d1, []int{2}
}
...
func (m *EventExtension) GetVersion() int32 {
	if m != nil {
		return m.Version
	}
	return 0
...
func (m *SigChain) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.PeerId) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintSigchain(dAtA, i, uint64(len(m.PeerId)))
...
func init() {
	proto.RegisterFile("crypto/sigchain/sigchain.proto", fileDescriptor_sigchain_c82f7aa4d38351d1)
}

var fileDescriptor_sigchain_c82f7aa4d38351d1 = []byte{
	// 460 bytes of a gzipped FileDescriptorProto
	,
}
