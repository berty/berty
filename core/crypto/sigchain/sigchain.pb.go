...
/*
	Package sigchain is a generated protocol buffer package.

	It is generated from these files:
		crypto/sigchain/sigchain.proto
...
func (EventExtensionVersions) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorSigchain, []int{0}
}
...
func (SigEvent_SigEventType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorSigchain, []int{0, 0}
}
...
func (*SigEvent) Descriptor() ([]byte, []int) { return fileDescriptorSigchain, []int{0} }
...
func (*SigChain) Descriptor() ([]byte, []int) { return fileDescriptorSigchain, []int{1} }
...
func (*EventExtension) Descriptor() ([]byte, []int) { return fileDescriptorSigchain, []int{2} }
...
func (m *SigEvent) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x32
	i++
	i = encodeVarintSigchain(dAtA, i, uint64(types.SizeOfStdTime(m.CreatedAt)))
...
func init() { proto.RegisterFile("crypto/sigchain/sigchain.proto", fileDescriptorSigchain) }

var fileDescriptorSigchain = []byte{
