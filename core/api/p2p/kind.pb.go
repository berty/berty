...
type ConversationNewMessageAttrs struct {
	Message *berty_entity3.Message `protobuf:"bytes,1,opt,name=message" json:"message,omitempty"`
}
...
func (*ConversationNewMessageAttrs) Descriptor() ([]byte, []int) { return fileDescriptorKind, []int{8} }

func (m *ConversationNewMessageAttrs) GetMessage() *berty_entity3.Message {
	if m != nil {
		return m.Message
	}
	return nil
...
func encodeFixed64Kind(dAtA []byte, offset int, v uint64) int {
	dAtA[offset] = uint8(v)
...
func encodeFixed32Kind(dAtA []byte, offset int, v uint32) int {
	dAtA[offset] = uint8(v)
	dAtA[offset+1] = uint8(v >> 8)
	dAtA[offset+2] = uint8(v >> 16)
	dAtA[offset+3] = uint8(v >> 24)
