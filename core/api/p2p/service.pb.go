...
func (*Void) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_acc8445f8d4eea69, []int{0}
}
...
func (c *serviceClient) Handle(ctx context.Context, in *Event, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/berty.p2p.Service/Handle", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() { proto.RegisterFile("api/p2p/service.proto", fileDescriptor_service_acc8445f8d4eea69) }

var fileDescriptor_service_acc8445f8d4eea69 = []byte{
