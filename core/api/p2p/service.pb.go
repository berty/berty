...
func (*Void) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_fee1abf43f65ccfd, []int{0}
}
...
func (c *serviceClient) Ping(ctx context.Context, in *Void, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
...
func _Service_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).Ping(ctx, req.(*Void))
	}
	return interceptor(ctx, in, info, handler)
}
...
func init() { proto.RegisterFile("api/p2p/service.proto", fileDescriptor_service_fee1abf43f65ccfd) }

var fileDescriptor_service_fee1abf43f65ccfd = []byte{
	...
	,
}
