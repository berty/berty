...
func (*ContactRequestInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_16a01b6c717a7ccc, []int{0}
}
...
func (*ConversationAddMessageInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_16a01b6c717a7ccc, []int{1}
}
...
func (*EventListInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_16a01b6c717a7ccc, []int{2}
}
...
func (*ConversationManageMembersInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_16a01b6c717a7ccc, []int{3}
}
...
func (*Void) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_16a01b6c717a7ccc, []int{4}
}
...
func init() { proto.RegisterFile("api/node/service.proto", fileDescriptor_service_16a01b6c717a7ccc) }

var fileDescriptor_service_16a01b6c717a7ccc = []byte{
	// 838 bytes of a gzipped FileDescriptorProto
	,
}
