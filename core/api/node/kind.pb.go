...
func (Kind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_kind_ba5c6873d34d76f1, []int{0}
}
...
func (*NodeStoppedAttrs) Descriptor() ([]byte, []int) {
	return fileDescriptor_kind_ba5c6873d34d76f1, []int{1}
}
...
func (*NodeIsAliveAttrs) Descriptor() ([]byte, []int) {
	return fileDescriptor_kind_ba5c6873d34d76f1, []int{2}
}
...
func (*BackgroundErrorAttrs) Descriptor() ([]byte, []int) {
	return fileDescriptor_kind_ba5c6873d34d76f1, []int{3}
}
...
func (*BackgroundWarnAttrs) Descriptor() ([]byte, []int) {
	return fileDescriptor_kind_ba5c6873d34d76f1, []int{4}
}
...
func (*DebugAttrs) Descriptor() ([]byte, []int) {
	return fileDescriptor_kind_ba5c6873d34d76f1, []int{5}
}
...
func (*StatisticsAttrs) Descriptor() ([]byte, []int) {
	return fileDescriptor_kind_ba5c6873d34d76f1, []int{6}
}
...
func init() { proto.RegisterFile("api/node/kind.proto", fileDescriptor_kind_ba5c6873d34d76f1) }

var fileDescriptor_kind_ba5c6873d34d76f1 = []byte{
