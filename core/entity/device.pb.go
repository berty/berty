...
func (m *Device) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x12
	i++
	i = encodeVarintDevice(dAtA, i, uint64(types.SizeOfStdTime(m.CreatedAt)))
	...
	dAtA[i] = 0x1a
	i++
	i = encodeVarintDevice(dAtA, i, uint64(types.SizeOfStdTime(m.UpdatedAt)))
	...
	if m.DeletedAt != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintDevice(dAtA, i, uint64(types.SizeOfStdTime(*m.DeletedAt)))
