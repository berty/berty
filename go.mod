...
replace (
	...
	github.com/libp2p/go-libp2p-rendezvous => github.com/n0izn0iz/go-libp2p-rendezvous v0.0.0-20211012121303-5f2ef79d5758 // use berty fork of go-libp2p-rendezvous with sqlcipher support
