...
replace (
	...
	github.com/libp2p/go-libp2p-quic-transport => github.com/gfanton/go-libp2p-quic-transport v0.1.2-0.20220505161611-70c8b4581447 // waiting for https://github.com/libp2p/go-libp2p/pull/1476
