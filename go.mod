...
require (
	...
	berty.tech/go-ipfs-repo-encrypted v1.1.4-0.20220725113219-229f0730dded
...
replace (
	...
	github.com/mutecomm/go-sqlcipher/v4 => github.com/berty/go-sqlcipher/v4 v4.4.3-0.20220725104208-0cbeed4e7219 // plaintext header support
