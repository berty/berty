...
T extends beapi.messenger.StreamEvent.Type.TypeConversationPartialLoad ? beapi.messenger.StreamEvent.IConversationPartialLoad :
T extends beapi.messenger.StreamEvent.Type.TypePeerStatusConnected ? beapi.messenger.StreamEvent.IPeerStatusConnected :
T extends beapi.messenger.StreamEvent.Type.TypePeerStatusReconnecting ? beapi.messenger.StreamEvent.IPeerStatusReconnecting :
T extends beapi.messenger.StreamEvent.Type.TypePeerStatusDisconnected ? beapi.messenger.StreamEvent.IPeerStatusDisconnected :
T extends beapi.messenger.StreamEvent.Type.TypePeerStatusGroupAssociated ? beapi.messenger.StreamEvent.IPeerStatusGroupAssociated :
T extends beapi.messenger.StreamEvent.Type.TypeServiceTokenAdded ? beapi.messenger.StreamEvent.IServiceTokenAdded :
never
...
T extends beapi.messenger.StreamEvent.Notified.Type.TypeGroupInvitation ? beapi.messenger.StreamEvent.Notified.IGroupInvitation :
never
...
T extends beapi.messenger.AppMessage.Type.TypeAccountDirectoryServiceRegistered ? beapi.messenger.AppMessage.IAccountDirectoryServiceRegistered :
T extends beapi.messenger.AppMessage.Type.TypeAccountDirectoryServiceUnregistered ? beapi.messenger.AppMessage.IAccountDirectoryServiceUnregistered :
T extends beapi.messenger.AppMessage.Type.TypeServiceAddToken ? beapi.messenger.AppMessage.IServiceAddToken :
T extends beapi.messenger.AppMessage.Type.TypeServiceRemoveToken ? beapi.messenger.AppMessage.IServiceRemoveToken :
T extends beapi.messenger.AppMessage.Type.TypePushSetDeviceToken ? beapi.messenger.AppMessage.IPushSetDeviceToken :
T extends beapi.messenger.AppMessage.Type.TypePushSetServer ? beapi.messenger.AppMessage.IPushSetServer :
T extends beapi.messenger.AppMessage.Type.TypePushSetMemberToken ? beapi.messenger.AppMessage.IPushSetMemberToken :
never
