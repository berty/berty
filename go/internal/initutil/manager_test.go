...
func verifyRunningLeakDetection(t *testing.T) {
	...
	goleak.VerifyNone(t,
		...
		goleak.IgnoreTopFunction("github.com/libp2p/go-libp2p/p2p/discovery/mdns_legacy.(*mdnsService).pollForEntries.func1"), // upstream issue of mdns, go wakeup periodiclly to do action before check exist, timeout about 10 seconds
