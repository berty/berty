...
func (x *EchoStreamTest_Request) GetDelay() uint64 {
	if x != nil {
		return x.Delay
	}
	return 0
...
var file_go_internal_testutil_proto_rawDesc = []byte{
	...
	0x0a, 0x05, 0x64, 0x65, 0x6c, 0x61, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x64,
	...
	0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x64, 0x65, 0x6c, 0x61, 0x79, 0x12, 0x12,
...
var file_go_internal_testutil_proto_goTypes = []interface{}{
...
func file_go_internal_testutil_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_internal_testutil_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_internal_testutil_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_internal_testutil_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_internal_testutil_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_internal_testutil_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_internal_testutil_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_internal_testutil_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_internal_testutil_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_internal_testutil_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
