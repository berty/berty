...
var file_directorytypes_bertydirectory_proto_goTypes = []interface{}{
...
func file_directorytypes_bertydirectory_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_directorytypes_bertydirectory_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_directorytypes_bertydirectory_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Query); i {
			case 0:
				return &v.state
			case 1:
		...
		file_directorytypes_bertydirectory_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_directorytypes_bertydirectory_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Record); i {
			case 0:
				return &v.state
			case 1:
		...
		file_directorytypes_bertydirectory_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_directorytypes_bertydirectory_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_directorytypes_bertydirectory_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_directorytypes_bertydirectory_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_directorytypes_bertydirectory_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_directorytypes_bertydirectory_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
