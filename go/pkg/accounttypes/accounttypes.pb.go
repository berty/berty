...
type OpenAccount_Request struct {
	...
	// -------
	// FIXME:
	// - make skip_messenger_init the default behavior with no way to init messenger automatically
	// - remove skip_messenger_init
	...
	SkipMessengerInit    bool                          `protobuf:"varint,5,opt,name=skip_messenger_init,json=skipMessengerInit,proto3" json:"skip_messenger_init,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                      `json:"-"`
	XXX_unrecognized     []byte                        `json:"-"`
	XXX_sizecache        int32                         `json:"-"`
}
...
func (m *OpenAccount_Request) GetSkipMessengerInit() bool {
	if m != nil {
		return m.SkipMessengerInit
	}
	return false
}
...
var fileDescriptor_5d43f30c8e455603 = []byte{
	...
	,
}
...
func (m *OpenAccount_Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SkipMessengerInit", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
