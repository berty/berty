...
var (
	pattern_MessengerService_InstanceShareableBertyID_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"messenger", "v1", "InstanceShareableBertyID"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MessengerService_DevShareInstanceBertyID_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"messenger", "v1", "DevShareInstanceBertyID"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MessengerService_ParseDeepLink_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"messenger", "v1", "ParseDeepLink"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MessengerService_SendContactRequest_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"messenger", "v1", "SendContactRequest"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MessengerService_SendMessage_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"messenger", "v1", "SendMessage"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MessengerService_SendAck_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"messenger", "v1", "SendAck"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MessengerService_SystemInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"messenger", "v1", "SystemInfo"}, "", runtime.AssumeColonVerbOpt(true)))
)
