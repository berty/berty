...
func TestServiceParseDeepLink(t *testing.T) {
	tests := []struct {
		...
		{"internal", &ParseDeepLink_Request{Link: "BERTY://PB/" + validContactInternalBlob}, nil, true, true},
		{"internal-2", &ParseDeepLink_Request{Link: "berty://pb/" + validContactInternalBlob}, nil, true, true},
