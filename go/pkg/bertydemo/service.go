...
func (d *Service) logFromToken(ctx context.Context, token string) (orbitdb.EventLogStore, error) {
	d.logsMutex.Lock()
...
func (d *Service) LogToken(ctx context.Context, _ *LogToken_Request) (*LogToken_Reply, error) {
...
func (d *Service) LogAdd(ctx context.Context, req *LogAdd_Request) (*LogAdd_Reply, error) {
...
func (d *Service) LogGet(ctx context.Context, req *LogGet_Request) (*LogGet_Reply, error) {
	log, err := d.logFromToken(ctx, req.GetLogToken())
	if err != nil {
		return nil, errcode.TODO.Wrap(err)
	}
...
func (d *Service) LogList(ctx context.Context, req *LogList_Request) (*LogList_Reply, error) {
	log, err := d.logFromToken(ctx, req.GetLogToken())
	if err != nil {
		return nil, errcode.TODO.Wrap(err)
	}
...
func (d *Service) LogStream(req *LogStream_Request, srv DemoService_LogStreamServer) error {
