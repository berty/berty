...
var (
	pattern_ReplicationService_ReplicateGroup_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"berty.replication.v1.ReplicationService", "ReplicateGroup"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ReplicationService_ReplicateGlobalStats_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"berty.replication.v1.ReplicationService", "ReplicateGlobalStats"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ReplicationService_ReplicateGroupStats_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"berty.replication.v1.ReplicationService", "ReplicateGroupStats"}, "", runtime.AssumeColonVerbOpt(true)))
)
