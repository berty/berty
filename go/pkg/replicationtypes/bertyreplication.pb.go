...
type ReplicatedGroup struct {
	...
	MetadataEntriesCount int64  `protobuf:"varint,5,opt,name=metadata_entries_count,json=metadataEntriesCount,proto3" json:"metadata_entries_count,omitempty"`
	MetadataLatestHead   string `protobuf:"bytes,6,opt,name=metadata_latest_head,json=metadataLatestHead,proto3" json:"metadata_latest_head,omitempty"`
	MessageEntriesCount  int64  `protobuf:"varint,7,opt,name=message_entries_count,json=messageEntriesCount,proto3" json:"message_entries_count,omitempty"`
	MessageLatestHead    string `protobuf:"bytes,8,opt,name=message_latest_head,json=messageLatestHead,proto3" json:"message_latest_head,omitempty"`
}
...
var fileDescriptor_07ad8506da4f8389 = []byte{
	...
	,
}
...
func (m *ReplicatedGroup) Size() (n int) {
	...
	if m.UpdatedAt != 0 {
		n += 1 + sovBertyreplication(uint64(m.UpdatedAt))
	}
	if m.MetadataEntriesCount != 0 {
		n += 1 + sovBertyreplication(uint64(m.MetadataEntriesCount))
	}
	...
	if m.MessageEntriesCount != 0 {
		n += 1 + sovBertyreplication(uint64(m.MessageEntriesCount))
	}
