...
var (
	pattern_PushService_ServerInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"berty.push.v1.PushService", "ServerInfo"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_PushService_Send_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"berty.push.v1.PushService", "Send"}, "", runtime.AssumeColonVerbOpt(true)))
)
