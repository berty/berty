...
var (
	...
	pattern_MessengerService_DirectoryServiceRegister_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"berty.messenger.v1", "MessengerService", "DirectoryServiceRegister"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MessengerService_DirectoryServiceUnregister_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"berty.messenger.v1", "MessengerService", "DirectoryServiceUnregister"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MessengerService_DirectoryServiceQuery_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"berty.messenger.v1", "MessengerService", "DirectoryServiceQuery"}, "", runtime.AssumeColonVerbOpt(true)))
)
