...
func main() {
	...
	serveFlags.StringVar(&emitterAdminKey, "emitter-admin-key", emitterAdminKey, "admin key of the emitter-io server (ie. tcp://127.0.0.1:8080)")
	serveFlags.StringVar(&emitterServer, "emitter-server", emitterServer, "address of the emitter-io server")
