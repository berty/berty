...
export class DemoServiceClient {
	...
	addKey(
		request: api.berty.protocol.AddKey.IRequest,
		callback: (error: Error | null, response?: api.berty.protocol.AddKey.IReply) => void,
	) {
		return this._pbService.addKey.bind(this._pbService)(request, callback)
	}
	log(
		request: api.berty.protocol.Log.IRequest,
		callback: (error: Error | null, response?: api.berty.protocol.Log.IReply) => void,
	) {
		return this._pbService.log.bind(this._pbService)(request, callback)
	}
	logAdd(
	...
	logStream(
		...
		callback: (error: Error | null, response?: api.berty.protocol.Log.IOperation) => void,
	) {
