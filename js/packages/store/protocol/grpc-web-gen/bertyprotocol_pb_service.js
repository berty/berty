...
ProtocolService.DebugGroup = {
  methodName: "DebugGroup",
  service: ProtocolService,
  requestStream: false,
  responseStream: false,
  requestType: bertytypes_pb.DebugGroup.Request,
  responseType: bertytypes_pb.DebugGroup.Reply
};
...
ProtocolServiceClient.prototype.debugGroup = function debugGroup(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(ProtocolService.DebugGroup, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
