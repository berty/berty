...
export const berty = {
            ...
            ConversationSetSeenPositionRequest: jsonPb.lookup('.berty.chat.ConversationSetSeenPositionRequest'),
            ...
            ConversationUpdateSettingsRequest: jsonPb.lookup('.berty.chat.ConversationUpdateSettingsRequest'),
            ConversationUpdateSettingsReply: jsonPb.lookup('.berty.chat.ConversationUpdateSettingsReply'),
            ConversationInvitationAcceptRequest: jsonPb.lookup('.berty.chat.ConversationInvitationAcceptRequest'),
            ConversationInvitationAcceptReply: jsonPb.lookup('.berty.chat.ConversationInvitationAcceptReply'),
            ConversationInvitationCreateRequest: jsonPb.lookup('.berty.chat.ConversationInvitationCreateRequest'),
            ConversationInvitationCreateReply: jsonPb.lookup('.berty.chat.ConversationInvitationCreateReply'),
            ConversationInvitationDiscardRequest: jsonPb.lookup('.berty.chat.ConversationInvitationDiscardRequest'),
            ConversationInvitationDiscardReply: jsonPb.lookup('.berty.chat.ConversationInvitationDiscardReply'),
            ...
            AccountPairingInvitationCreateRequest: jsonPb.lookup('.berty.chat.AccountPairingInvitationCreateRequest'),
            AccountPairingInvitationCreateReply: jsonPb.lookup('.berty.chat.AccountPairingInvitationCreateReply'),
            AccountRenewIncomingContactRequestLinkRequest: jsonPb.lookup('.berty.chat.AccountRenewIncomingContactRequestLinkRequest'),
            AccountRenewIncomingContactRequestLinkReply: jsonPb.lookup('.berty.chat.AccountRenewIncomingContactRequestLinkReply'),
