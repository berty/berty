...
export const berty = {
	...
	messenger: {
		v1: {
			...
			SendReplyOptions: jsonPb.lookup('.berty.messenger.v1.SendReplyOptions'),
			...
			ReplyOption: jsonPb.lookup('.berty.messenger.v1.ReplyOption'),
			...
			SetGroupName: jsonPb.lookup('.berty.messenger.v1.SetGroupName'),
		},
	},
}
