...
//  Berty
//
//  Created by Godefroy Ponsinet on 29/08/2019.
...
@interface RCT_EXTERN_REMAP_MODULE_2(NotificationModule, Notification, NSObject)

RCT_EXTERN_METHOD(display:(NSString *)title
                  body:(NSString *)body
                  icon:(NSString *)icon
